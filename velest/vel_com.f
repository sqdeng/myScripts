...
c
      integer ieq,inshot,itotmodels,inltot,ist,maxobsperevent
      parameter(ieq=985)      ! number of earthquakes (Simultaneous mode)
c     parameter(ieq=1)        ! number of earthquakes (single event mode ONLY)
     ...
     &          inltot=99,    ! max. number of layers per velocity model
     &          ist=275,      ! max. number of stations in stationlist
     &          maxobsperevent=270) ! max. number of observations per event
c
c
c-----------------------------------------------------------------------------
c
c	  character*40 outmodfile
      integer(kind=8) ilip,inva,ikva,inrpmax
